...
/*
// get minute returns the char value stored in the node
//
char Node::getMinuto()
{
     return dtHr.minuto;
...
// get seconds returns the char value stored in the node
//
Node::char getSegundo()
{
     return dtHr.segundo;
}

// get year returns the char value stored in the node
//
char Node::getAno()
{
     return dtHr.ano;
...
// get month returns the char value stored in the node
//
char Node::getMes()
{
     return dtHr.mes;
...
// get day returns the char value stored in the node
//
char Node::getDia()
{
     return dtHr.dia;
